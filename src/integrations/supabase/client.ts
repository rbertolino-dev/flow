...
import { immediateAuthLock } from '@/lib/supabaseAuthLock';
...
export const supabase = createClient<Database>(SUPABASE_URL, SUPABASE_PUBLISHABLE_KEY, {
  auth: {
    ...
    // Sem Navigator Lock API: evita AbortError com chamadas paralelas a getUser/getSession
    lock: immediateAuthLock,
  },
  realtime: {
    params: {
      eventsPerSecond: 10,
