...
import { AgilizeClientesImportWizard } from "@/components/superadmin/agilize-clientes/ImportWizard";
...
export default function SuperAdminAgilizeClientes() {
            ...
            <div className="flex justify-center p-6">
              <Alert variant="destructive" className="max-w-md">
                ...
                <AlertDescription>
                  ...
                  <p className="mt-2">Esta área é restrita a Super Administradores.</p>
                </AlertDescription>
              </Alert>
            </div>
          ) : (
            <AgilizeClientesImportWizard />
          )}
        </div>
      </CRMLayout>
    </AuthGuard>
