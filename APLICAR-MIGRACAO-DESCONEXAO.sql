-- ============================================
-- MIGRAÇÃO: Sistema de Avisos de Desconexão
...
DROP POLICY IF EXISTS "Users can view disconnection notifications of their organization" ON public.instance_disconnection_notifications;
DROP POLICY IF EXISTS "Service can insert disconnection notifications" ON public.instance_disconnection_notifications;
DROP POLICY IF EXISTS "Users can update disconnection notifications of their organization" ON public.instance_disconnection_notifications;
...
BEGIN
  IF NOT EXISTS (
    ...
    AND table_name = 'instance_disconnection_notifications'
  ) THEN
    RAISE EXCEPTION 'Tabela instance_disconnection_notifications não foi criada!';
  END IF;
