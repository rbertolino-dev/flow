-- ============================================
-- CORREÇÕES PARA MÓDULO DE CONTRATOS
...
-- Se a tabela contract_reminders já existe, atualizar o CHECK constraint
DO $$
BEGIN
...
BEGIN
  IF NOT EXISTS (
    ...
    ADD COLUMN category_id UUID REFERENCES public.contract_categories(id) ON DELETE SET NULL;
  END IF;
END $$;
...
-- 5. VERIFICAR SE FUNÇÕES NECESSÁRIAS EXISTEM
-- ============================================

-- Verificar se is_pubdigital_user existe
DO $$
BEGIN
  IF NOT EXISTS (
