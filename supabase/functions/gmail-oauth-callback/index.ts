...
serve(async (req) => {
  ...
  try {
    ...
    if (error) {
      ...
      return new Response(
        ...
        <body>
          ...
          <p><a href="/gmail">Voltar para Gmail</a></p>
        </body>
        </html>
        `,
        { 
    ...
    // Buscar email do usuário do Google
    ...
    // Fallback: tentar decodificar id_token
    ...
    // Verificar se já existe uma conta com o mesmo refresh_token
    ...
    if (existingWithSameToken) {
      ...
      if (updateError) {
        ...
        throw new Error('Falha ao atualizar configuração do Gmail');
      }
      ...
      if (insertError) {
        ...
        throw new Error('Falha ao salvar configuração do Gmail');
      }
    ...
    return new Response(
      ...
      <body>
        ...
        <p>Você pode fechar esta janela e voltar para o portal do Gmail.</p>
        <a href="/gmail" class="button">Voltar para Gmail</a>
        <script>
          if (window.opener) {
            try {
