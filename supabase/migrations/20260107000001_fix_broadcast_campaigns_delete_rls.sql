-- =====================================================
-- FIX: Permitir DELETE em broadcast_campaigns para membros da organização
-- =====================================================
-- Problema: Usuários não conseguem excluir campanhas canceladas
-- Solução: Criar política RLS para DELETE
