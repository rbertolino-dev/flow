-- Adicionar campos CNPJ, telefone e email de contato na tabela organizations
-- Estes campos serão usados nos orçamentos e contratos
...
COMMENT ON COLUMN public.organizations.contact_email IS 'Email de contato da organização para aparecer em orçamentos e contratos';
