...
MIGRATION_FILE="$SCRIPT_DIR/../supabase/migrations/20260322200000_pos_sales_filter_fields.sql"
TEMP_FILE="/tmp/pos_sales_filter_fields.sql"
...
echo "✅ Migration filter fields applied"
