...
MIGRATION_FILE="$SCRIPT_DIR/../supabase/migrations/20260322180000_pos_sales_confirm_fields.sql"
TEMP_FILE="/tmp/pos_sales_confirm_fields.sql"
...
echo "✅ Migration confirm fields aplicada"
