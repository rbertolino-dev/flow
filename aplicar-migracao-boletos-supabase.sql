...
-- Execute tudo de uma vez copiando este arquivo completo
-- ============================================
...
-- ============================================
-- VERIFICAÇÃO: Execute após aplicar a migração
-- ============================================
-- SELECT * FROM information_schema.tables WHERE table_name = 'whatsapp_boletos';
-- SELECT * FROM pg_indexes WHERE tablename = 'whatsapp_boletos';
-- SELECT * FROM pg_policies WHERE tablename = 'whatsapp_boletos';
